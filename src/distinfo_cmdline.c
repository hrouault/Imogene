/*
  ...
  gengetopt --file-name=distinfo_cmdline -i distinfo.ggo --unamed-opts=<motifs>
...
const char *gengetopt_args_info_purpose = "Distance between PWM.";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --wnames            Input motifs with names",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->width_help = gengetopt_args_info_help[2] ;
  args_info->threshold_help = gengetopt_args_info_help[3] ;
  args_info->wnames_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->wnames_given)
    write_into_file(outfile, "wnames", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVw:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* Input motifs with names.  */
          if (strcmp (long_options[option_index].name, "wnames") == 0)
          {
          
          
            if (update_arg( 0 , 
                 0 , &(args_info->wnames_given),
                &(local_args_info.wnames_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "wnames", '-',
                additional_error))
              goto failure;
