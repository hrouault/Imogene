/*
  ...
  gengetopt --input=extract.ggo --func-name=extract_cmdline_parser --arg-struct-name=extract_args_info --file-name=extract_cmdline 
...
const char *extract_args_info_purpose = "Alignment extraction.";

const char *extract_args_info_usage = "Usage: " EXTRACT_CMDLINE_PARSER_PACKAGE " [OPTIONS]...";
...
static
void clear_given (struct extract_args_info *args_info);
static
void clear_args (struct extract_args_info *args_info);

static int
extract_cmdline_parser_internal (int argc, char **argv, struct extract_args_info *args_info,
...
static
void init_args_info(struct extract_args_info *args_info)
{
...
static void print_help_common(void) {
  ...
  if (strlen(extract_args_info_purpose) > 0)
    printf("\n%s\n", extract_args_info_purpose);

  if (strlen(extract_args_info_usage) > 0)
    printf("\n%s\n", extract_args_info_usage);

  printf("\n");

  if (strlen(extract_args_info_description) > 0)
    printf("%s\n\n", extract_args_info_description);
}
...
extract_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (extract_args_info_help[i])
    printf("%s\n", extract_args_info_help[i++]);
}

void
extract_cmdline_parser_init (struct extract_args_info *args_info)
{
...
static void
extract_cmdline_parser_release (struct extract_args_info *args_info)
{
...
int
extract_cmdline_parser_dump(FILE *outfile, struct extract_args_info *args_info)
{
  int i = 0;
...
int
extract_cmdline_parser_file_save(const char *filename, struct extract_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
...
void
extract_cmdline_parser_free (struct extract_args_info *args_info)
{
...
int
extract_cmdline_parser (int argc, char **argv, struct extract_args_info *args_info)
{
  return extract_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
extract_cmdline_parser_ext (int argc, char **argv, struct extract_args_info *args_info,
                   struct extract_cmdline_parser_params *params)
{
  int result;
...
int
extract_cmdline_parser2 (int argc, char **argv, struct extract_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct extract_cmdline_parser_params params;
...
int
extract_cmdline_parser_required (struct extract_args_info *args_info, const char *prog_name)
{
...
extract_cmdline_parser_internal (
  int argc, char **argv, struct extract_args_info *args_info,
                        struct extract_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error = 0;
  struct extract_args_info local_args_info;
